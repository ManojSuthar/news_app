...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<NewsModelEntity>[] is M) {
      return data
              .map<NewsModelEntity>(
                (Map<String, dynamic> e) => NewsModelEntity.fromJson(e),
              )
              .toList()
          as M;
    }
    if (<NewsModelSource>[] is M) {
      return data
              .map<NewsModelSource>(
                (Map<String, dynamic> e) => NewsModelSource.fromJson(e),
              )
              .toList()
          as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (NewsModelEntity).toString(): NewsModelEntity.fromJson,
    (NewsModelSource).toString(): NewsModelSource.fromJson,
  };
